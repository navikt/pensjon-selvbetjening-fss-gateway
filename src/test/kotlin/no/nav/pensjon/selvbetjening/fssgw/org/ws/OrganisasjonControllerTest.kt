...
@WebMvcTest(OrganisasjonController::class)
internal class OrganisasjonControllerTest {
    ...
    @Test
    fun `unauthorized service request results in response status Unauthorized`() {
        mvc.perform(
            post(SERVICE_PATH)
                .header(HttpHeaders.CONTENT_TYPE, MediaType.TEXT_XML_VALUE)
                .content(REQUEST_BODY))
    ...
    private companion object {
        const val SERVICE_PATH = "/ws/OrganisasjonService/v4"
